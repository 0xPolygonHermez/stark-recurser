...
describe("GL in BN128 circuit", function () {
    ...
    before( async() => {
        circuitMul = await wasm_tester(path.join(__dirname, "circom", "glmul.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
        circuitCMul = await wasm_tester(path.join(__dirname, "circom", "glcmul.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
        circuitMulAdd = await wasm_tester(path.join(__dirname, "circom", "glmuladd.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
        circuitCMulAdd = await wasm_tester(path.join(__dirname, "circom", "glcmuladd.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
        circuitCMulAdd2 = await wasm_tester(path.join(__dirname, "circom", "glcmuladd2.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
        circuitInv = await wasm_tester(path.join(__dirname, "circom", "glinv.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
        circuitCInv = await wasm_tester(path.join(__dirname, "circom", "glcinv.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
    });
