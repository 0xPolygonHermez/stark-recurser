...
describe("FFT Circuit Test", function () {
    ...
    before( async() => {
        circuitFFT = await wasm_tester(path.join(__dirname, "circom", "fft.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
        circuitIFFT = await wasm_tester(path.join(__dirname, "circom", "ifft.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
    });
