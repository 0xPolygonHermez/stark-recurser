...
describe("Merkle Hash Circuit Test", function () {
    ...
    before( async() => {
        ...
        circuit = await wasm_tester(path.join(__dirname, "circom", "merklehash.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
    });
