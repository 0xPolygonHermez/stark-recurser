...
describe("Less Than Goldilocks Circuit Test", function () {
    ...
    before( async() => {
        circuitLessThan = await wasm_tester(path.join(__dirname, "circom", "lessthangl.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
    });
