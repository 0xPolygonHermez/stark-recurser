...
describe("Verify Evals Goldilocks Circuit Test", function () {
    ...
    before(async() => {
        circuitVerifyEvals = await wasm_tester(path.join(__dirname, "circom", "verifyEvals.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
        circuitVerifyEvalsMin = await wasm_tester(path.join(__dirname, "circom", "verifyEvalsMin.bn128.test.circom"), {O:1, include: ["src/pil2circom/circuits.bn128", "node_modules/circomlib/circuits"]});
