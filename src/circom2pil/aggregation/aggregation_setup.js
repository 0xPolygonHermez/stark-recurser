...
function calculatePlonkConstraintsRows(plonkConstraints, nineExtraConstraints, threeExtraConstraints, twoExtraConstraints, oneExtraConstraint) {
    let partialRows = {};
    let halfRows = [];
    let r = 0;
...
*/
module.exports.aggregationCompressor = function aggregationCompressor(r1cs, options) {
...
module.exports.getCompressorConstraints = getNumberConstraints;